...
export const RIOSM: BaseModel = 
{
    ...
    url: 'https://drive.google.com/file/d/1_d9WOmZxJsq6fvwktyI0a7EZT3fLMDh9/view',
    shortName: 'RIOSM',
    ...
    questions: [
        ...
        text: <span>Choose the statement that best describes how your institution's <strong>leadership is engaged</strong> in research informatics:</span>, 
        options: [
                {
        ...
        text: <span>Choose the statement that best describes your institution's <strong>research informatics governance approach</strong>:</span>,
        options: [
                {
        ...
        text: <span>How does your institution feel about the <strong>reputational value</strong> of research informatics?</span>, 
        options: [
                {
        ...
        text: <span>Choose the statement that best describes your institution's overall <strong>support for open science</strong>:</span>,
        options: [
                {
        ...
        },
        {
            ...
            text: <span>Choose the statement that best describes how your institution supports data and software sharing through <strong>policy</strong>:</span>,
            options: [
                {
        ...
        text: <span>Choose the statement that best describes how your institution supports data and software sharing through <strong>educational and technological support</strong>:</span>,
        options: [
                {
        ...
        text: <span>Choose the statement that best describes your institution's <strong>data analytics</strong> activities:</span>,
        options: [
                {
        ...
        text: <span>Choose the statement that best describes the current status of your institution's <strong>clinical trial management system (CTMS)</strong>:</span>,
        options: [
                {
        ...
        text: <span>Choose the statement that best describes your institution's <strong>use of external data</strong> in your enterprise data warehouse (EDW):</span>,
        options: [
                {
        ...
        text: <span>Choose the statement that best describes your institution's <strong>research computing</strong> capabilities:</span>,
        options: [
                {
        ...
        text: <span>Choose the statement that best describes your institution's <strong>secondary use of data</strong>:</span>,
        options: [
                {
