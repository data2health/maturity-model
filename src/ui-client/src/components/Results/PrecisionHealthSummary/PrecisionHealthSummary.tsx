...
export default class PrecisionHealthSummary extends React.PureComponent<Props> {
    private className = 'precision-health-summary';
        ...
        return (
            <div className={c}>
                ...
                <div className={`${c}-breakdown`}>
                    {PrecisionHealth.questions.map((q, i) => {
                            ...
                            <div className={`${c}-breakdown-container`} key={q.answerField}>
                                <Container>
                                    <Row>
                                        ...
                                        <Col><div className={`${c}-breakdown-primary-top`}><strong>Average</strong> {results.all.precision_health}</div></Col>
