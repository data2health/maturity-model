...
import { setNoClickModalState } from '../../../actions/general';
import { NoClickModalState, NotificationStates } from '../../../model/GeneralState';
...
export default class NoClickModal extends React.Component<Props> {
    ...
    public render() {
        ...
        const classes = [ 'maturity-model-modal', 'noclick-modal', (state.state === NotificationStates.Complete ? 'complete' : '') ];
